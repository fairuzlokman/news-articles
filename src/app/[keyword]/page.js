...
const Page = ({ params }) => {
	...
	return (
		<div className="relative bg-fixed bg-cover bg-default-image">
			...
			<Header />
			<div className="max-w-[1280px] flex flex-col gap-1 relative z-10 m-auto overflow-y-scroll no-scrollbar h-[calc(100vh-56px)]">
				...
				{everythingData.articles.map((item, index) => (
					<Link key={index} href={item.url} target="_blank">
						<div className="flex gap-6 p-6 bg-white/85">
							<div>
